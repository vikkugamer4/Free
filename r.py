...
bot = telebot.TeleBot('7861458890:AAELMEzs-xr0C57SF1Z7s9NYSaQOdXMfwVs')
...
MAX_ATTACK_TIME = 1200  # Example: Default maximum attack time set to 600 seconds
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if attack_time > MAX_ATTACK_TIME:
                ...
                full_command = f"./tagdi {target} {port} {attack_time} 512 1200"  # ✅ Correct variable name
